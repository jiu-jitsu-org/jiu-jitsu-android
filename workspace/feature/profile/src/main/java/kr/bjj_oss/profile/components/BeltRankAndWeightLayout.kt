...
import kr.bjj_oss.ui.theme.CoolGray50
import kr.bjj_oss.ui.theme.TrueWhite
import kr.bjj_oss.ui.theme.White
import kr.bjj_oss.ui.theme.drawableRes
    ...
    if (beltRank == null && weightKg == null) {
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    text = stringResource(kr.bjj_oss.ui.R.string.common_belt),
                    style = MaterialTheme.typography.titleSmall,
                    color = ColorComponents.TextFieldDisplay.Default.Title,
                )
                Image(
                    ...
                    painter = painterResource(beltRank?.drawableRes() ?: kr.bjj_oss.ui.R.drawable.ic_white_belt),
            ...
            Column(
                ...
                Text(
                    text = stringResource(kr.bjj_oss.ui.R.string.common_weight),
                    style = MaterialTheme.typography.titleSmall,
                    color = ColorComponents.TextFieldDisplay.Default.Title,
                )
                if (isWeightHidden) {
