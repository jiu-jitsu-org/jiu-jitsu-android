...
import kr.bjj_oss.model.BELT_RANK_LIST
import kr.bjj_oss.model.BELT_STRIPE
import kr.bjj_oss.model.BELT_STRIPE_LIST
import kr.bjj_oss.model.GENDER
import kr.bjj_oss.model.GENDER_LIST
import kr.bjj_oss.domain.combineToDouble
...
private fun InputBeltRank(
    ...
    Column(
        ...
        PrimaryButton(
            ...
            text = stringResource(kr.bjj_oss.profile.R.string.profile_pass_belt),
...
private fun InputWeight(
    ...
    Column(
        ...
        Row(
            ...
            Row {
                Text(
                    text = stringResource(kr.bjj_oss.profile.R.string.profile_weight_hide_toggle),
                    style = Typography.titleMedium,
                )
                CommonToggleButton(
