...
private fun PositionInfo(
    ...
    StyleInfoSection(
        titleRes = kr.bjj_oss.ui.R.string.common_position,
...
private fun TechniqueInfo(
    ...
    StyleInfoSection(
        titleRes = kr.bjj_oss.ui.R.string.common_technique,
...
private fun SubmissionInfo(
    ...
    StyleInfoSection(
        titleRes = kr.bjj_oss.ui.R.string.common_submission,
...
private fun StyleInfoSection(
    ...
    val emptyItemName = stringResource(kr.bjj_oss.ui.R.string.common_item_null)
        ...
        Row(
            ...
            StyleCardItem(
                modifier = Modifier
                    ...
                    .height(cardHeight),
                iconRes = bestIconRes,
                titleRes = kr.bjj_oss.ui.R.string.common_my_best,
            ...
            StyleCardItem(
                ...
                titleRes = kr.bjj_oss.ui.R.string.common_my_favorite,
